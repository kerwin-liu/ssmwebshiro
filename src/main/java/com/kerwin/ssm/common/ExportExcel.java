...
public class ExportExcel {
    ...
    //构造方法，传入要导出的数据
    public ExportExcel(String title, String[] rowName, List<Object[]> dataList, HttpServletResponse response, String fileUrl) {
...
//                    workbook.write(out);/
                    ...
                    String endTime = DateUtils.getStringDateShort();
                    Date date = DateUtils.strToDate(endTime);
                    Calendar cl = Calendar.getInstance();
                    cl.setTime(date);
                    String startTime = DateUtils.getBeforeDay(cl);
                    s = fileUrl + "日报"+startTime + ".xls";
